...
const personas = [
  ...
  },
  {
    ...
    priority: '💎',
    nameZh: '文献修复师#01',
    nameEn: 'The Archive Restorer #01',
      ...
      <div className="br-wrap">
        ...
        <header className="br-header">
          <div className="br-logo">
            <div className="br-logo-icon">M</div>
            <div>
              <div className="br-logo-name">Mist</div>
        ...
        <footer className="br-footer">
          {isZh
            ? 'Mist 情绪短视频全案 · 2026 · 仅供内部演示使用'
            : 'Mist Emotional Short Video Project · 2026 · Internal Demo Only'}
        </footer>
      </div>
    </div>
  )
