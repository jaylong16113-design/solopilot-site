    ...
    <>
      ...
      <article className="max-w-3xl mx-auto article-content">
        <div className="flex items-center gap-2 text-xs text-gray-400 mb-4 px-4 pt-6">
          ...
          <span>/</span>
          <Link href="/en/mood" className="hover:text-gray-600">Mood Videos</Link>
          <span>/</span>
        ...
        <div className="px-4">
          ...
          <div className="flex flex-wrap gap-2 mt-8 pt-6 border-t border-gray-100">
            <span className="tag bg-pink-100 text-pink-600">Mood Videos</span>
            <span className="tag bg-gray-100 text-gray-500">AI Tools</span>
            <span className="tag bg-gray-100 text-gray-500">Tutorial</span>
          </div>

          <div className="flex justify-between mt-8 pt-4 border-t border-gray-100 text-sm">
            <Link href="/en/mood" className="text-pink-600 hover:underline">← Back to Mood Videos</Link>
