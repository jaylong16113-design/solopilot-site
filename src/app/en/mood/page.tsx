    ...
    <div>
      <section className="bg-gradient-to-b from-pink-50 to-white px-4 py-12 md:py-16 -mx-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-2xl md:text-4xl font-extrabold tracking-tight mb-3">Emotional Short Videos</h1>
          ...
          <div className="flex justify-center gap-2 mt-4 text-xs text-gray-400">
            <span className="tag bg-pink-100 text-pink-600">{totalMood} articles</span>
          </div>
        </div>
      </section>
