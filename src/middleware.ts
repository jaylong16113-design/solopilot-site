...
const TOOL_PATHS = ['/axiom', '/forge', '/blaze', '/hunter', '/mist', '/lens', '/pulse', '/growth', '/cascade', '/compass', '/study', '/login']
...
export const config = {
  matcher: ['/axiom/:path*', '/forge/:path*', '/blaze/:path*', '/hunter/:path*', '/mist/:path*', '/lens/:path*', '/pulse/:path*', '/growth/:path*', '/cascade/:path*', '/compass/:path*', '/study/:path*']
}
